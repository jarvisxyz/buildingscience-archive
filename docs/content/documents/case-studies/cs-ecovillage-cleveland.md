...
![](https://www.buildingscience.com/sites/default/files/oh_cleveland_ecovillage_completed_500x400.jpg?itok=87o3CkgO)**![](https://www.buildingscience.com/sites/default/files/oh_cleveland_ecovillage_panels_533x400.jpg?itok=Y6DCDo4_)  
Building A front elevation ***(above left)***; solar panels on Building A garage** *(above right)*
### Key Features
...
The drawings and construction details for the EcoVillage project run more than 60 pages. They include complete framing layout and detailed cross sections for every wall assembly (and there are many different types). The drawings were designed to be used at the job site by the site superintendent and all of the trades. The EcoVillage set of drawings is complemented by the project specifications. Throughout the project specs are specific references to building principles and detailed graphics from the [Builder’s Guide to Cold Climates](http://www.buildingsciencepress.com/Builders-Guide-to-Cold-Climates-P91.aspx) ([Building Science Press Inc.](http://www.buildingsciencepress.com/)). The general contractor and each subcontractor at EcoVillage will receive a copy of this Builder ’s Guide.
[![](/sites/default/files/resize/migrate/jpg/Foundation_black-400x333.jpg)](/sites/default/files/migrate/jpg/Foundation_black.jpg)  
...
[![](/sites/default/files/migrate/jpg/Balcony_black.jpg)](/sites/default/files/migrate/jpg/Balcony_black.jpg)**  
...
[![](/sites/default/files/resize/migrate/jpg/Window_sill_black-300x212.jpg)](/sites/default/files/migrate/jpg/Window_sill_black.jpg)**  
...
See the "[EcoVillage Energy Analysis](/sites/default/files/migrate/pdf/Ecovillage_energy_analysis_rev2013.pdf)" for more information about energy savings.