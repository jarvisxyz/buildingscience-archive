BSC Role
[Researcher](/taxonomy/term/87)
Services Provided
[Research, Development and Demonstration](/services/research-development-and-demonstration)
Location
Waterloo, ON
...
![](https://www.buildingscience.com/sites/default/files/styles/panopoly_image_original/public/meterbox_interior.jpg?itok=3xZjR7-E)| Hot-box Interior (Meter Box)Key improvements of the TM apparatus over other (i.e. conventional) hot boxes are:
  * the ability to test higher R-value enclosure assemblies
  * a procedure and design that exposes enclosure wall samples to realistic temperature differences while maintaining the interior temperature at normal room temperatures
  * the ability to measure the impact of imposed air flow at a given pressure difference over the specimen in either direction.
...
During Phase II, testing was completed on a series of wood-framed wall assemblies that were selected to represent common construction methods in regions throughout North America. Five wall assemblies were constructed to achieve a nominal insulation R-value of 13 (RSI 2.28), using 2x4 framing at 16 in (406 mm) on center. The following stud-space insulation materials have been tested:
  * Damp-sprayed cellulose fiber insulation
  * Inset-stapled kraft-faced fiberglass batt
  * Face-stapled kraft-faced fiberglass batt
  * Open-cell sprayed polyurethane foam
...
Two additional assemblies were constructed to examine the impact of adding more insulation:
  * 2x4 @ 16” (406 mm) o.c. with nominal R13 (RSI 2.28) friction-fit fiberglass batt + nominal R5 (RSI 0.88) 1” (25.4 mm) XPS exterior insulating sheathing
  * 2x6 @ 16” (406 mm) o.c. with nominal R21 (RSI 3.70) friction-fit fiberglass batt


All of the assemblies had realistic but minimal thermal bridging (i.e. no extra framing beyond regularly spaced studs at 16 in (406 mm) on center, a double top plate, and single bottom plate, resulting in a 13.6% framing factor) and were more airtight than most real wall assemblies (e.g. 0.05 to 0.20 cfm50/ft2, 0.25 to 1.00 L/sm2@50Pa) .
![](https://www.buildingscience.com/sites/default/files/styles/panopoly_image_original/public/double_guard.jpg?itok=5d0KBxpx)| Double Guard on Meter BoxAn insulated guard box (left) minimizes the influence of temperature changes in the lab and reduces spatial temperature gradients over the meter box surface. A hydronic guard loop is installed over the outside surface of the meter box (right) to further reduce any spatial temperature gradients; it also all but eliminates any temperature difference between the inside and the outside of the meter box walls (minimizing if not eliminating heat flow through the five enclosing sides of the meter box).  
---|---  
## Who is Involved
Partners in the TM Consortium include:
  ...
  * Icynene
  * NAIMA (the North American Insulation Manufacturers Association)


Principal researchers from Building Science Corporation are:
Joseph Lstiburek, John Straube, Chris Schumacher, Aaron Grin, Robert Lepage.
![](https://www.buildingscience.com/sites/default/files/styles/panopoly_image_original/public/bsc_wall_construction_group.jpg?itok=E8v18pWW)| BSC Researchers Constructing Calibration PanelsCommissioning and calibration were conducted by BSC for the measurement and control subsystems and for the complete TM hot box apparatus. Construction, commissioning, and calibration were completed between 2007 and 2009. A base set of walls was then tested to develop a set of reference values for future research.  
---|---  
...
#### R-values change with temperature. 
All of the insulation materials tested to date exhibited temperature-dependent thermal performance. For the insulations used, the temperature-dependence effect resulted in improved thermal performance at lower temperatures (e.g. an outdoor temperature of 0°F, -18°C resulted in roughly a 10% improvement in thermal performance of the insulation) and reduced thermal performance at higher temperatures (e.g. an outdoor temperature of 144°F, 62°C resulted in roughly a 15% decrease in thermal performance of the insulation).
...
#### **Air flow is complex and needs to be better understood.**
The energy impact of airflow appears to be affected by the flow path and the interaction between the air and the materials in the assembly. Conventional models may over-predict the energy impact of air leakage through walls when there is a significant air flow interaction effect.
![](https://www.buildingscience.com/sites/default/files/styles/panopoly_image_original/public/spacers.jpg?itok=GBaN79W6)| Spacer InstallationIn developing the test box method, a variety of spacers and spacer locations were compared in order to attain a representative and repeatable imposed gap for air leakage. The final design used 1/32 in (0.8 mm) spacers to create the imposed air leakage path between components of the assembly.   
---|---  
Research is ongoing. Areas for future analysis include the role of air leakage in hot boxes, and the validation of computer models (e.g. MOISTURE-EXPERT) through comparisons of predicted vs. measured values.
Project Files
[Thermal Metric Summary Report - Updated June 2015](/sites/default/files/project/20150618_thermal_metric_summary_report_-_june_2015_update.pdf)
[Thermal Metric Summary Report](/sites/default/files/project/bsc_thermal_metric_summary_report_2013-10-21.pdf)
[![](/sites/default/files/styles/square/public/project/calibration_group_195x124.jpg?itok=xO7UOi5I) ](https://buildingscience.com/sites/default/files/project/calibration_group_195x124.jpg "The Thermal Metric Project")
[![](/sites/default/files/styles/square/public/project/jonathan_outside_the_hotbox_555xabout_355.jpg?itok=ytQDiu-C) ](https://buildingscience.com/sites/default/files/project/jonathan_outside_the_hotbox_555xabout_355.jpg "The Thermal Metric Project")
[![](/sites/default/files/styles/square/public/project/meter_box_interior_156x209.jpg?itok=blVCckcN) ](https://buildingscience.com/sites/default/files/project/meter_box_interior_156x209.jpg "The Thermal Metric Project")
[![](/sites/default/files/styles/square/public/project/spacers_190x120.jpg?itok=OwuDm4nT) ](https://buildingscience.com/sites/default/files/project/spacers_190x120.jpg "The Thermal Metric Project")